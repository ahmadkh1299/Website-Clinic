<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PHistory.aspx.cs" Inherits="PHistory" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="background-color: #0066FF">
        ...
        &nbsp;<asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="*" ForeColor="Red"
            MinimumValue="1/1/1948" Type="Date" ControlToValidate="TextBoxSearch"></asp:RangeValidator>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxSearch"
    ...
    <asp:DataList ID="DataListHistory" runat="server" BackColor="White" BorderColor="#CCCCCC"
        ...
        Width="100%" Height="541px" Style="margin-bottom: 0px" RepeatDirection="Horizontal">
        <ItemTemplate>
            <table>
                <tr>
                ...
                <tr>
                    <td colspan="2">
                        <center>
                            ...
                            <br />
                            <br />
                            <asp:TextBox ID="TextBox1" runat="server" Enabled="False" Height="57px" Text='<%# Bind("Description") %>'
